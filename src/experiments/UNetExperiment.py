...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # Feed data to the model and feed target to the loss function --DONE--
            ...
            # ANSWER: 1. dimension:, 2. dimension: 3.+4. dimension: image dimensions
